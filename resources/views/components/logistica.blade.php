       ...
       <div
         ...
         <div
           ...
           <ul class="nav flex-column">
             ...
             <li class="nav-item">
               <a class="nav-link d-flex align-items-center gap-2" href="/panel_de_control/Logistica">
                 <svg class="bi" aria-hidden="true">
       ...
       <div class="table-responsive mt-5">
        <div>
         ...
         <div class="btn-group ml-auto " role="group" aria-label="Basic example">
           <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> <i class="bi bi-clipboard-plus"></i> Nuevo Material</button>
