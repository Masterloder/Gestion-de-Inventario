 ...
 <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-white">
   <div
     ...
     <div
       class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3"
       style="height: 90vh;">

       <ul class="nav flex-column gap-1 w-100">

         <li class="nav-item">
           <a class="nav-link d-flex align-items-center gap-3 active text-dark fw-semibold rounded-3 p-3 bg-light" href="{{ asset('/panel_de_control') }}" aria-current="page">
         ...
         <li class="nav-item">
           <a
             class="nav-link d-flex justify-content-between align-items-center text-dark rounded-3 p-3"
