    ...
    <section class="offcanvas offcanvas-start bg-primary" id="menuLateral" tabindex="-1">
        ...
        <div
            ...
            <a
                ...
                <span class="fs-4"><img src="{{ asset('images/Logos/LogotipoInver.png') }}" width="200" height="50" class="d-inline-block align-left img-fluid " alt="Logo"></span>
            </a>
            <hr />
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="/panel_de_control" class="nav-link text-white">
                        <svg
                            class="bi pe-none me-2"
                            width="16"
                            height="16"
